        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TypingStatuses_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TypingStatuses_ChatRooms_ChatRoomId",
                        column: x => x.ChatRoomId,
                        principalTable: "ChatRooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "25b65578-aef6-4a22-b95d-5cc6a40b56c1", null, "Admin", "ADMIN" },
                    { "2a5b8357-2e5f-424d-9594-6b19e771f1d9", null, "Editor", "EDITOR" },
                    { "71188503-db87-4b43-9782-266f9a42bb2c", null, "User", "USER" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TypingStatuses_ChatRoomId",
